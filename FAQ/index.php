    ...
    <ul class="faq-text">
      <li>
        <div class="question-arrow">
          <span class="question">What our platform do?</span>
      ...
      <li>
        <div class="question-arrow">
          <span class="question">How to search a doctor?</span>
          <i class="bx bxs-chevron-down arrow"></i>
        </div>
      ...
      <li>
        <div class="question-arrow">
          <span class="question">What is PREDICO? How does it work?</span>
          <i class="bx bxs-chevron-down arrow"></i>
        </div>
      ...
      <li>
        <div class="question-arrow">
          <span class="question">What are our goals?</span>
          <i class="bx bxs-chevron-down arrow"></i>
        </div>
